...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, beehive):
        ...
        curplace = self.place
        count = 0
        while count < self.min_range and curplace != beehive:
            curplace = curplace.entrance
            count += 1
        while curplace != beehive and count <= self.max_range:
            retbee = rANTdom_else_none(curplace.bees)
            if retbee:
                return retbee
            curplace = curplace.entrance
            count += 1
...
class FireAnt(Ant):
    ...
    def reduce_armor(self, amount):
        ...
        "*** YOUR CODE HERE ***"
        firep = self.place
        bees_place = firep.bees[:]
        Ant.reduce_armor(self, amount)
        for bee in bees_place:
            bee.reduce_armor(amount)
        if self.armor == 0:
            left_bees = firep.bees[:]
            for bee in left_bees:
...
class HungryAnt(Ant):
    ...
    def action(self, gamestate):
        ...
        "*** YOUR CODE HERE ***"
        curplace = self.place
        targetbee = rANTdom_else_none(curplace.bees)
...
class QueenAnt(ScubaThrower):  # You should change this line
    ...
    def __init__(self, armor=1):
        # BEGIN Problem EC
        "*** YOUR CODE HERE ***"
        if QueenAnt.queen_ex == False:
            self.queenornot = True
            QueenAnt.queen_ex = True
        else:
            self.queenornot = False
    ...
    def action(self, gamestate):
        ...
        if self.queenornot:
            ...
            while curplace != None:
                if curplace.ant and curplace.ant.doubled == False:
                    curplace.ant.doubled = True
    ...
    def reduce_armor(self, amount):
        ...
        if self.armor == 0 and self.queenornot:
            bees_win()
        # END Problem EC

    def remove_from(self, place):
        if not self.queenornot:
...
def make_slow(action, bee, length):
...
def make_scare(action, bee, length):
...
class LaserAnt(ThrowerAnt):
    ...
    def insects_in_front(self, beehive):
        ...
        dic = {}
        curplace = self.place
        if curplace.ant is not self:
            dic[curplace.ant] = 0
        for bee in curplace.bees:
            dic[bee] = 0
        curplace = curplace.entrance
        dis = 1
        while curplace != beehive:
            if curplace.ant is not None:
                dic[curplace.ant] = dis
            bees = curplace.bees
            for bee in bees:
                dic[bee] = dis
            dis += 1
            curplace = curplace.entrance
        """
        for insect, distance in dic.items():
            print("DEBUG:", insect.name, distance)
        """
    ...
    def calculate_damage(self, distance):
        # BEGIN Problem Optional 5
        basedamage = 2
        retdam = basedamage - 0.2 * distance - self.insects_shot * 0.05
        if retdam > 0:
            return retdam
        else:
            return 0
